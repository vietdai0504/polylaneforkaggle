...
class PolyRegression(nn.Module):
    def __init__(self,
        ...
        self.vit_encoder = ViTEncoder(input_dim=num_outputs, embed_dim=vit_embed_dim, num_heads=vit_num_heads, num_layers=vit_num_layers)
    ...
    def forward(self, x, epoch=None, **kwargs):
        ...
        # Apply ViT Encoder
        papfn_output = self.vit_encoder(papfn_output.unsqueeze(1))
